  ...
  template: `
      <header class="header-1">
          ...
          <div class="header-nav">
              <a *ngFor="let area of appAreas" [routerLink]="area.link" routerLinkActive="active" class="nav-link" (click)="setSelectedArea(area)"><span class="nav-text">{{area.title}}</span></a>
    ...
    this.appAreas = [
      ...
      },
      {
        ...
        subRoutes: [{
          ...
          {title: "Logins", link: "admin/logins", summary: "Manage Logins ", rolesAllowed: ["admin"], subRoutes: null},
          {title: "Teams", link: "admin/teams", summary: "Teams and Membership", rolesAllowed: ["admin"], subRoutes: null}],
        rolesAllowed: ["admin"],
        summary: "Overview of Regression"
      }
    ]
