...
@Component({
  ...
  template: `<span class="spinner" *ngIf="!(vm$ | async)">
  Loading...
</span>
  ...
  <div class="card" *ngIf="vm$ | async as vm">
    <div class="card-header">
      History
      <qa-regression-header-create class="add-regression-button"></qa-regression-header-create>
    </div>
      ...
      >
        <clr-datagrid [(clrDgSingleSelected)]="selected">
          ...
          >
            ...
            <clr-dg-cell>
              <button  class="btn btn-sm btn-info" (click)="completeRegression(regression)">
                Complete Regression
              </button>
